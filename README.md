# Next + Netlify + TypeScript & ESlint Starter
...
This is a [Next.js](https://nextjs.org/) v11.1 project bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app) and set up to be instantly deployed to [Netlify](https://url.netlify.com/SyTBPVamO)! This project has been modified as a TypeScript project and includes ESlint rules and Prettier configuration.
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/nickbrinser/next-netlify-typescript&utm_source=github&utm_medium=nextstarter-cs&utm_campaign=devex-cs)
